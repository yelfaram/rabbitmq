...
# bind queue to exchange with a binding key that receieves all messages from europe
channel.queue_bind(exchange='topic_routing', queue=queue_name, routing_key='*.europe.*')
